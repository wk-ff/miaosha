...
public interface OrderDao {
    ...
    OrderInfo getOrderInfoByUserIdGoodsId(@Param("userId")long userId,
    ...
    @Select("select * from order_info where id = #{goodsId}")
    OrderInfo getOrderInfoByGoodsId(@Param("goodsId") long orderId);
}
